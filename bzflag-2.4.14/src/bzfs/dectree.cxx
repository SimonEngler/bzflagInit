...
namespace aicore
{
	...
	void DecisionTrees::init()
	{
		...
		doUpdateMotionDecisions[0].falseBranch = &doUpdateMotionActions[0];
                ...
                doUpdateMotionDecisions[1].decFuncPtr = &RobotPlayer::nonIsExpired;
		...
		doUpdateMotionDecisions[4].decFuncPtr = &RobotPlayer::returnFalse;
		doUpdateMotionDecisions[4].trueBranch = &doUpdateMotionActions[2];
		doUpdateMotionDecisions[4].falseBranch = &doUpdateMotionActions[1];
